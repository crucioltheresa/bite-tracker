...
### Visit Entity
    ...
    **Fields:**
    ...
    - `dishes_ordered` (Text, Optional) — Comma-separated list (max 500 chars)
    - `recommended_dishes` (Text, Optional) — Recommended items (max 500 chars)
    - `beverage_ordered` (Text, Optional) — Beverages (max 200 chars)
...
### Prerequisites
    ...
    ```bash
    git clone https://github.com/username/bite-tracker
    cd bite-tracker
    ```
